    ...
    <div class="row">
        <div class="col-md-9">
            <div class="form-group">
                ...
                <input type="text" name="customer_email" v-model="form.customer_email" id="email" class="form-control">

                <span class="error-message" v-if="errors.has('customer_email')" v-text="errors.get('customer_email')"></span>
            </div>
        </div>
        ...
        <div class="col-md-9">
            <div class="form-group">
                ...
                <input type="text" name="customer_phone" v-model="form.customer_phone" id="phone" class="form-control">
            </div>
        </div>
        ...
        <div class="col-md-18">
            <div class="form-group create-an-account-label">
                <div class="form-check">
                    <input type="checkbox" name="create_an_account" v-model="form.create_an_account" id="create-an-account">
                ...
                <div class="row">
                    <div class="col-md-9">
                        <div class="form-group">
                            ...
                            <span class="error-message"v-if="errors.has('billing.password')"v-text="errors.get('billing.password')">
                            </span>
                        </div>
                    </div>
                </div>
