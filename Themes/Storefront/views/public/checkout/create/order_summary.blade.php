<aside class="order-summary-wrap">
    <div class="order-summary">
            ...
            <div class="shipping-methods" v-cloak>
                ...
                <div class="form-group" v-if="hasShippingMethod">
                    <div class="form-radio" v-for="shippingMethod in cart.availableShippingMethods">
                        <input type="radio" name="shipping_method" v-model="form.shipping_method" :value="shippingMethod.name" :id="shippingMethod.name" @change="updateShippingMethod(shippingMethod)">
        ...
        <div class="order-summary-bottom">
            ...
            <button type="submit" class="btn btn-primary btn-place-order" :class="{ 'btn-loading': placingOrder }" :disabled="! form.terms_and_conditions || ! hasShippingMethod" v-else v-cloak>
